...
export const themeConfig = {
    ...
    },
    {
      ...
      list: [
        ...
        },
        {
          ...
          url: "https://github.com/wangshiyulin/twikoo-cloudflare"
        }
      ],
    },
  ],
  ...
  footer: {
    ...
    social: [
      ...
      {
        icon: "github",
        link: "https://www.github.com/wangshiyulin/",
      },
      {
        icon: "telegram",
  ...
  rewardData: {
    enable: true,
    // 微信二维码
    wechat: "/images/screenshot/wechat.png",
    // 支付宝二维码
    alipay: "/images/screenshot/alipay.jpg",
  },
  // 图片灯箱
  fancybox: {
    enable: true,
