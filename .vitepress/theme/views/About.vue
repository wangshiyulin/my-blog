  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 往世雨</span>
        <span class="text3">是一名 交易员、独立开发者、博主</span>
      </div>
      
      <!-- 追求 -->
      <div class="about-item pursuit">
        <span class="tip">追求</span>
        <span class="title2">在27岁之前财务自由</span>
        <span class="title2">去做热爱的事</span>
        <span class="title2">去过梦想的生活</span>
      </div>
    </div>
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-content" style="grid-template-columns: 1fr 1.5fr">
          ...
          <div class="about-item career">
            ...
            <div class="list">
              <span class="list-item" style="--color: #357ef5">NJUCM · 计算机科学与技术</span>
            </div>
          </div>
    ...
    <div class="about-content" style="display: flex">
      <div class="about-item">
        ...
        <p class="text">
            回忆一下，为什么想有个自己的博客呢？<strong>记录此刻所思，创造未来之物</strong>，大抵我是想留下什么
        </p>
        <p class="text">
            带着好奇心，我尝试并学习过很多<strong>知识和技术</strong>，它们已经或即将被记录在这里，如果能帮到你，我也会很开心
        </p>
        <p class="text">
            这是我的一方小小天地，<strong>探索世界，也寻找自己</strong>
        </p>
      </div>
    </div>
  </div>
